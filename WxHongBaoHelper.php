...
class WxHongBaoHelper
{
	...
	/**
	  例如：
	 	appid：    $this->parameters["wxappid"]
		mch_id：   $this->parameters["mch_id"]
		device_info：  1000
		Body：    test
		nonce_str：  $this->parameters["nonce_str"]
	...
	protected function get_sign(){
		//商户平台> 账户设置> 安全设置 >api安全> api密钥> api设置
		define('PARTNERKEY',"PanyuzeJihaiboLihanlunZhaoshuang");//微信支付密钥
		try {
